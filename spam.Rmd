...
cuales son las diferencias entre cada uno de los modelos.
...
Demos un vistazo rápido a el resto de métricas
...
`r resaltar("El modelo seleccionado es **knn**")`

Una vez que tenemos el modelo correcto, con los parámetros seleccionados,
volveremos que volver a entrenarlo con toda la base disponible (train + test)
obteniendo el modelo definitivo que puedes poner en producción
